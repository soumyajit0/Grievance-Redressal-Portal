...
if (strlen($_SESSION['id']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($compfile)) {
            // If no file is uploaded, use the default image path and set the extension
            $compfile = "nofile.png";
            $extension = ".png";
            //rename the image file
            $compfilenew = md5($compfile) . $extension;
            // Code for move default image into directory
            copy("nofile.png", "complaintdocs/" . $compfilenew);
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <form method="post" name="complaint" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Complaint Related Document (If any)</label>
