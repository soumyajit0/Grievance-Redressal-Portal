							...
							<li class="notification">
								...
								while ($row = mysqli_fetch_array($rt)) {
									...
									<div class="media">
										...
										<img class="img-radius" src="assets/images/user/user.png"
										...
										<div class="media-body">
											...
											<p>Complaint No.<a
													...
													<?php echo htmlentities($row['complaintNumber']); ?> at <small>
			...
			<li>
				<div class="dropdown drp-user">
					...
					<div class="dropdown-menu dropdown-menu-right profile-notification">
						...
						<ul class="pro-body">
							<li><a href="admin-profile.php" class="dropdown-item"><i class="feather icon-user"></i>
									Profile</a></li>
