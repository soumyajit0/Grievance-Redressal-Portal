...
<head>
	<title>Grievance Redressal Portal | User Login</title>
...
<div class="auth-wrapper">
	<div class="auth-content text-center">
		<h4>Grievance Redressal Portal
			<hr /><span style="color:#132043;"> User Login</span>
		</h4>
						...
						<div class="card-body">
							...
							<div class="form-group mb-3">
								...
								<input type="email" name="emailid" id="emailid" class="form-control"
									onBlur="emailAvailability()" required placeholder="Enter Registered Email Address">
							</div>
