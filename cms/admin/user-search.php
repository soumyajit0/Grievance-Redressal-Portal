...
if (strlen($_SESSION['aid']) == 0) {
    ...
    <head>
        <title>Grievance Redressal Portal | Users Search</title>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <input class="form-control" type="search" name="search"
                                                    placeholder="Search By Mobile Number/Name/Email" required="true">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <?php if (isset($_POST['submit'])) {
                                                ...
                                                ?>
                                                <br>
                                                <h4 align="center" style="color:blue">Search agianst:
                                                    <?php echo $search; ?>
                                                </h4>
                                                <hr />
                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if ($count > 0) {
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="6" style="color:red; font-size:16px;">No record
                                                                            found</td>
                                                                    </tr>
