...
if (strlen($_SESSION['aid']) == 0) {
    ...
    <head>
        <title>Grievance Redressal Portal | Between Dates Users Report</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="between-date-userreport.php">Between Dates Users
                                            Report</a></li>
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-4"><input type="date" name="fromdate" class="form-control"
                                                    required></div>
                                        </div>

                                        <div class="row" style="margin-top:1%;">
                                            <div class="col-2">To Date</div>
                                            <div class="col-4"><input type="date" name="todate" class="form-control"
                                                    required></div>
                                        </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <?php if (isset($_POST['submit'])) {
                                                ...
                                                ?>
                                                <br>
                                                <h4 align="center" style="color:blue">Orders Report Form
                                                    <?php echo $fdate; ?> To
                                                    <?php echo $tdate; ?>
                                                </h4>
                                                <hr />
